...
| Table 3 (Section 4.3) | The campaigns similarity clustering surfaced | none | not regenerated here; `paper/supplementary/suspicious-scaffold-clusters.md` holds the campaign-consistent clusters that fell short of confirmation and so are absent from this table | Not applicable; the table was compiled by hand from triage of the archived scan |
